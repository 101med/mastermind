...
def game_over(won=False, code=[1, 2, 3, 4], r=9, data={}) -> None:
    try:
        if won:
            ...
            message = f"You won, your score is {(ROUNDS - r):02}/{ROUNDS}."  # 29 cols
        else:
            header = "Oops!"
